...
nightmare
  ...
  .click('div.banner:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > a:nth-child(1)') //click show all bets
  .wait(1500)
  .evaluate(function () {
	...
	lines.forEach((line)=>{
		try {
			...
			if(marja>0&&!isNaN(marja)){
				...
				let coeff = new Coefficient({bk: 'bk1xbet', betType:'line', averageType:'immediate', date: now, sport: sportType, marja: marja, win: win, draw: draw, away: away}).save();
			}
