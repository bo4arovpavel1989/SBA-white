...
var getRequests = [
	...
	},
	{
		url:'/vacancy/:id',
		middleware:middleware.noMiddleware,
		callback:getRequestsHandlers.getVacancyPage
	},
	{
		url:'/experts/:id',
		middleware:middleware.noMiddleware,
...
var postRequests = [
	...
	{
		url:'/admin/geteditlineform',
		middleware:middleware.checkAccess,
		callback:postRequestsHandlers.getEditLineForm
	},
	{
		url:'/admin/geteditsocialpageform',
		middleware:middleware.checkAccess,
		callback:postRequestsHandlers.getEditSocialForm
	}
];
