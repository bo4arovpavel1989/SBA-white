...
var postRequests = require('./postrequests.js');
...
var getRequests = [
	{
		...
		callback: getRequests.getMainPage
	},
	{
		url: '/showinfo',
		middleware: middleware.noMiddleware,
	...
	},
	{
		url:'/eventaddform',
		middleware: middleware.noMiddleware,
		callback: getRequests.getEventAddForm
	},
	{
		url:'/eventpage',
		middleware: middleware.noMiddleware,
		callback: getRequests.getEventPage
	}
];
...
var postRequests = [
	{
		url:'/addevent',
		middleware:middleware.noMiddleware,
		callback:postRequests.addEvent
	}
];
